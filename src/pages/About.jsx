    ...
    <main>
      <section className="section">
        ...
        <div className="about__text__container">
          ...
          <ul>
            <li className="text--list">I make my own clay earrings</li>
            <li className="text--list">I can almost quote the entirety of Hot Fuzz</li>
            <li className="text--list">I have a very long list of random animal facts</li>
            <li className="text--list">My favourite place to travel is Greece</li>
          </ul>
        </div>
      </section>
    </main>
